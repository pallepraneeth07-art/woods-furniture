      ...
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        <a href="#hero" className="flex items-center gap-3">
          ...
          <div className="hidden sm:block">
            <span className={`font-heading text-lg font-semibold tracking-wide ${scrolled ? "text-bone" : "text-walnut"}`}>
              WOODS
            </span>
            <span className={`font-heading text-lg font-light italic ml-1 ${scrolled ? "text-sandstone" : "text-sandstone"}`}>
              Furnitures
            </span>
          </div>
        </a>
