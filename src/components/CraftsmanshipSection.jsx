...
export default function CraftsmanshipSection() {
  return (
    <section id="craftsmanship" className="relative py-20 md:py-32 bg-walnut overflow-hidden hidden">
      {/* Background texture */}
      <div className="absolute inset-0 opacity-10 hidden">
        <img src={WOOD_TEXTURE} alt="" className="w-full h-full object-cover hidden" />
      </div>
